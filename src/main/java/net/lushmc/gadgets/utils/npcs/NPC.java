...
public class NPC {
	...
	NPC(String name, Location loc, String skin) {
		uid = new UID(10);
		while (NPCUtil.getNPC(uid) != null)
			uid = new UID(10);
		try {
			this.skin = skin;
			this.name = name;
	...
	public class ProfileLoader {
		...
		private void addProperties(GameProfile profile) {
			...
			try {
				...
				// Failed loading skin, have in mind the Mojang API is public and it have
				// restrictions
